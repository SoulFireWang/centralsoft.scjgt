...
- (void)drawBottomItems
{
    ...
    self.bottomItemsView = [[UIView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(self.view.frame) - 140,
                                                                      CGRectGetWidth(self.view.frame), 140)];
...
//    _bottomItemsView.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.6];
    ...
    [_btnFlash setTitle:@"取消" forState:UIControlStateNormal];
    _btnFlash.layer.borderColor = [UIColor whiteColor].CGColor;
    _btnFlash.layer.borderWidth = 2;
    _btnFlash.layer.cornerRadius = _btnFlash.frame.size.width/2;
    
    
//     [_btnFlash setImage:[UIImage imageNamed:@"CodeScan.bundle/qrcode_scan_btn_flash_nor"] forState:UIControlStateNormal];
    [_btnFlash addTarget:self action:@selector(cancelScan) forControlEvents:UIControlEventTouchUpInside];
...
- (void)showNextVCWithScanResult:(LBXScanResult*)strResult
{
    ...
    [params setObject:strResult.strScanned forKey:@"resultString"];
    
    [self.resultDelegate onResult:params requestCoe:REQUEST_CODE_SCAN responseCode:RESULT_OK];
